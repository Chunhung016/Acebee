              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2.5 py-2 rounded-lg border border-slate-200 text-xs font-medium bg-white"
                    id="teacher-quiz-subject-select"
                  >
                    {subjectsForQuizClass.map((subj) => (
              ...
              <div className="space-y-3 pt-2">
                ...
                {questions.map((q, qIndex) => (
                  ...
                  >
                    ...
                    {/* Inline Image Attachment for Quiz Builder */}
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 bg-white/70 p-2 border border-slate-200/60 rounded-lg">
                        ...
                        {q.imageUrl && (
                          <button
                            ...
                            onClick={() =>
                              setQuestions((prev) =>
                                prev.map((item, i) =>
                                  i === qIndex ? { ...item, imageUrl: undefined } : item
                                )
                              )
                            }
                      ...
                      <div className="flex-1 flex items-center gap-2">
                          ...
                          onChange={(e) => {
                            ...
                            if (file) {
                              ...
                              r.onloadend = () => {
                                setQuestions((prev) =>
                                  prev.map((item, i) =>
                                    i === qIndex ? { ...item, imageUrl: r.result as string } : item
                                  )
                                );
                              };
                        ...
                        />
                        <label
                          htmlFor={`inline-image-${q.id}`}
                          className="px-2 py-1 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 text-[10px] font-semibold rounded-md cursor-pointer flex items-center gap-1 shadow-2xs transition-all"
                        >
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setQuestions((prev) =>
                              prev.map((item, i) =>
                                i === qIndex ? { ...item, imageUrl: val || undefined } : item
                              )
                            );
                          }}
                          placeholder="Or paste image URL..."
                          className="flex-1 text-[11px] px-2 py-0.5 rounded border border-slate-200 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                        />
                      </div>
                      {q.imageUrl && (
                        <div className="w-10 h-10 border border-slate-200 rounded overflow-hidden flex items-center justify-center bg-slate-50 shrink-0">
                          <img
                            src={q.imageUrl}
                            alt="Preview"
